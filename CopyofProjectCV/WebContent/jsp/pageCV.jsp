...
<body>
    <div id="background">
        ...
        String sSel=request.getParameter("bEtudiant");
        ...
        %>
            ...
            <div style="position: absolute;top: -35px;left: 360px;"><p><%= etudiant.getMail()%></p></div>
            <div id="formationLyon">
                <div style="width:500px; height:200px;overflow:auto">
                    ...
                    <div class="rTable">
                        ...
                        <div class="rTableRow">
                            ...
                            <div class="rTableHead" style="width:39%"><span style="font-weight: bold;">Précision</span></div>
                ...
                <div style="width:700px; height:200px;overflow:auto">
                    ...
                    <div class="rTable">
                        <div class="rTableRow">
                            <div class="rTableHead" style="width:20%"><strong>Date</strong></div>
                            <div class="rTableHead" style="width:39%"><span style="font-weight: bold;">Diplôme</span></div>
                        ...
                        %>
                        <div class="rTableRow">
                            <div class="rTableCell" style="width:20%"><%= formationScolaire.getDate()%></div>
                            <div class="rTableCell" style="width:39%"><%= formationScolaire.getDiplome()%></div>
                            <div class="rTableCell" style="width:39%"><%= formationScolaire.getEcole()%></div>
                        </div>
                        <% } %>
                    </div>
                </div>
